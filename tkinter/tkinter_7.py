...
#radiobuttons
r1 = Radiobutton(root,text="R1", value=1,variable=var,) #setting variable is important
r1.grid(sticky="w",row=1,pady=10)

r2 = Radiobutton(root,text="R2", value=2,variable=var,relief=RIDGE) # relief is a effect
